                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/2 w-full">
                        ...
                        >
                            ...
                            Brain Health Playground has been a great addition to our cognitive wellness programmes. The motion detection and AI features help us keep users engaged with regular activity and see their training performance over time.
                            </p>
                    ...
                    <div className="p-4 md:w-1/2 w-full">
                        ...
                        >
                            ...
                            <p className="leading-relaxed mb-6 text-white transition-colors group-hover:text-gray-200">
                            Brain Health Playground has been a great addition to our residents&apos; daily routines. The AI-driven exercises are engaging and personalized, helping us support consistent participation.
                            </p>
                            <div className="inline-flex items-center">
                                <Image
                                    alt="testimonial"
                                ...
                                <span className="flex-grow flex flex-col pl-4">
                                    ...
                                    <span className="text-gray-700 text-sm">Program Coordinator</span>
                                </span>
                            </div>
                        </div>
                    </div>
