                    ...
                    <div className="lg:w-1/3 sm:w-1/2 p-4">
                        <div className="flex relative">
                            ...
                            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                ...
                                <p className="leading-relaxed text-xs">Strengthen both your mind and body through interactive exercises designed to boost cognitive function while keeping you physically active.</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 sm:w-1/2 p-4">
                        <div className="flex relative">
                            ...
                            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                ...
                                <p className="leading-relaxed text-xs">Engage in daily challenges that stimulate your brain and enhance memory, ensuring you stay sharp and focused throughout your day.</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 sm:w-1/2 p-4">
                        <div className="flex relative">
                            ...
                            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                ...
                                <p className="leading-relaxed text-xs">Experience the benefits of combining physical activity with cognitive training, promoting holistic brain health and overall well-being.</p>
                            </div>
                        </div>
                    </div>
                    {/* 추가 이미지들, 모바일에서는 숨기기 */}
                    <div className="lg:w-1/3 sm:w-1/2 p-4 hidden md:block">
                        <div className="flex relative">
                            ...
                            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                ...
                                <p className="leading-relaxed text-xs">Our program integrates cognitive training with physical exercises, helping you maintain both mental sharpness and physical fitness.</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 sm:w-1/2 p-4 hidden md:block">
                        <div className="flex relative">
                            ...
                            />
                            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                <h2 className="tracking-widest text-sm title-font font-medium text-cyan-400 mb-1">Social and Cognitive Engagement</h2>
                                <h1 className="title-font text-lg font-medium text-white mb-3">Connect and Improve</h1>
                                <p className="leading-relaxed text-xs">Connect with others while engaging in cognitive exercises designed to improve memory and social interaction, all from the comfort of your home.</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 sm:w-1/2 p-4 hidden md:block">
                        <div className="flex relative">
                            ...
                            />
                            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100">
                                <h2 className="tracking-widest text-sm title-font font-medium text-cyan-400 mb-1">Tailored Cognitive Routines</h2>
                                <h1 className="title-font text-lg font-medium text-white mb-3">Personalized Brain Workouts</h1>
                                <p className="leading-relaxed text-xs">Enjoy personalized cognitive routines that adapt to your individual needs, helping you maintain a healthy brain and a vibrant lifestyle.</p>
                            </div>
                        </div>
                    </div>
                </div>
