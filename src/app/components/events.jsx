        ...
        <section className="text-gray-400 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Your Ultimate Partner in
                        Preserving Memory</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Discover a range of cognitive exercises
                        that effortlessly stimulate your brain and enhance memory in your daily life. Utilizing
                        scientifically proven methods, our app helps reduce the risk of dementia and prepares you for a
                        healthy and vibrant future.</p>
                </div>
