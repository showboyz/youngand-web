        ...
        <section className="body-font text-gray-100">
            <div className="container mx-auto px-5 py-24">
                <div className="mb-20 flex w-full flex-col text-center">
                    <h1 className="title-font mb-4 text-2xl font-medium text-gray-100 sm:text-3xl">{t('features.title')}</h1>
                </div>
                <div className="-m-4 flex flex-wrap text-center">
                    <div className="w-full p-4 sm:w-1/2 md:w-1/4">
                        ...
                        >
                            ...
                            <p className="leading-relaxed transition-colors group-hover:text-gray-200">{t('features.items.0')}</p>
                        </div>
                    </div>
                    <div className="w-full p-4 sm:w-1/2 md:w-1/4">
                        <div
                        ...
                        >
                            ...
                            <p className="leading-relaxed transition-colors group-hover:text-gray-200">{t('features.items.1')}</p>
                        </div>
                    </div>
                    <div className="w-full p-4 sm:w-1/2 md:w-1/4">
                        <div
                        ...
                        >
                            ...
                            <p className="leading-relaxed transition-colors group-hover:text-gray-200">{t('features.items.2')}</p>
                        </div>
                    </div>
                    <div className="w-full p-4 sm:w-1/2 md:w-1/4">
                        <div
                        ...
                        >
                            ...
                            <p className="leading-relaxed transition-colors group-hover:text-gray-200">{t('features.items.3')}</p>
                        </div>
                    </div>
                </div>
            </div>
